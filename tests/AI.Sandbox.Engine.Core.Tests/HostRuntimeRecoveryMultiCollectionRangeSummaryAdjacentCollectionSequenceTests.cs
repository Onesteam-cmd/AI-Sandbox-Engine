...
public sealed class HostRuntimeRecoveryMultiCollectionRangeSummaryAdjacentCollectionSequenceTests
{
...
{
    var range = MultiCollectionRange();

    Xunit.Assert.Throws<ArgumentException>(
        () => global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryMultiCollectionCheckpointRangeSummaryFlow.ProjectSummary<
                RequestPayload,
                RecoveryWorldState,
                CompletionPayload>(
                    summaryId: default,
    ...
    Xunit.Assert.Throws<ArgumentNullException>(
        () => global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryMultiCollectionCheckpointRangeSummaryFlow.ProjectSummary<
                ...
                RecoveryWorldState,
                CompletionPayload>(
                    MultiCollectionCheckpointRangeSummaryProjectionId(),
                    null!,
                    expectedRangeRevision: 0,
                    projectedTick: 0));
    Xunit.Assert.Throws<ArgumentOutOfRangeException>(
        () => ProjectMultiCollectionRangeSummary(
            range,
    ...
    var summary = MultiCollectionRangeSummary(range);
    Xunit.Assert.Throws<ArgumentException>(
        () => global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryMultiCollectionCheckpointRangeSummaryFlow
            .SelectPreviousCollectionSequence<
                RequestPayload,
                RecoveryWorldState,
                CompletionPayload>(
                    selectionId: default,
                    summary: summary,
                    collectionPairCount: 1,
    ...
    Xunit.Assert.Throws<ArgumentNullException>(
        () => global::AI.Sandbox.Engine.Core.HostRuntime
            ...
            .SelectPreviousCollectionSequence<
                ...
                RecoveryWorldState,
                CompletionPayload>(
                    AdjacentCollectionSequenceSelectionId(),
                    null!,
                    collectionPairCount: 1,
...
[Xunit.Fact]
public void MultiCollectionSummaryRejectsStaleRevisionAndRegressedTick()
{
    var range = MultiCollectionRange();

    AssertMultiCollectionRangeSummaryStatus(
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryMultiCollectionCheckpointRangeSummaryStatus
            .StaleRangeRevision,
        ProjectMultiCollectionRangeSummary(
            range,
            expectedRangeRevision: checked(range.Revision + 1)));
    AssertMultiCollectionRangeSummaryStatus(
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryMultiCollectionCheckpointRangeSummaryStatus
...
[Xunit.Fact]
public void MultiCollectionSummaryPreservesExactCompactEvidence()
{
    var range = MultiCollectionRange();
    var result = ProjectMultiCollectionRangeSummary(
        range,
        projectedTick: checked(range.QueriedTick + 2));
    ...
    Xunit.Assert.Same(range.Sequence, summary.Sequence);
    Xunit.Assert.Same(range.SourceCollection, summary.SourceCollection);
    Xunit.Assert.Same(range.SourceProjection, summary.SourceProjection);
    Xunit.Assert.Same(range.Chain, summary.Chain);
    ...
    Xunit.Assert.Same(
        ...
        summary.CrossedBoundarySupersessions);
    Xunit.Assert.Equal(
        range.StartCheckpointIndex,
        summary.StartCheckpointIndex);
    Xunit.Assert.Equal(
        range.EndCheckpointIndex,
        summary.EndCheckpointIndex);
    Xunit.Assert.Equal(
        range.StartCollectionPairIndex,
        summary.StartCollectionPairIndex);
    Xunit.Assert.Equal(
        range.EndCollectionPairIndex,
        summary.EndCollectionPairIndex);
    ...
    Xunit.Assert.Equal(range.CollectionPairCount, summary.CollectionPairCount);
    Xunit.Assert.Equal(range.CrossedBoundaryCount, summary.CrossedBoundaryCount);
    Xunit.Assert.Equal(range.CrossedCollectionCount, summary.CrossedCollectionCount);
    Xunit.Assert.True(summary.CoversEntireSequence);
    Xunit.Assert.Equal(checked(range.Revision + 1), summary.Revision);
    Xunit.Assert.Equal(checked(range.QueriedTick + 2), summary.ProjectedTick);
}

[Xunit.Fact]
public void AdjacentSelectionRejectsStaleRevisionRegressedTickAndOversizedCount()
{
    var summary = MultiCollectionRangeSummary(MultiCollectionRange());

    AssertAdjacentCollectionSequenceStatus(
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryMultiCollectionCheckpointRangeSummaryStatus
            .StaleSummaryRevision,
        SelectPreviousCollectionSequence(
            summary,
            expectedSummaryRevision: checked(summary.Revision + 1)));
    AssertAdjacentCollectionSequenceStatus(
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryMultiCollectionCheckpointRangeSummaryStatus
    ...
    AssertAdjacentCollectionSequenceStatus(
        ...
        SelectPreviousCollectionSequence(
            ...
            collectionPairCount:
                global::AI.Sandbox.Engine.Core.HostRuntime
                    .HostRuntimeRecoveryMultiCollectionCheckpointRangeSummaryFlow
                    .MaximumAdjacentCollectionSequencePairCount + 1));
}

[Xunit.Fact]
public void PreviousSelectionRejectsMissingAdjacentCollectionSequence()
{
    var summary = MultiCollectionRangeSummary(MultiCollectionRange());
    var result = SelectPreviousCollectionSequence(summary);
...
[Xunit.Fact]
public void NextSelectionRejectsMissingAdjacentCollectionSequence()
{
    var summary = MultiCollectionRangeSummary(MultiCollectionRange());
    var result = SelectNextCollectionSequence(summary);
...
[Xunit.Fact]
public void FailedSelectionsPreserveSourceAuthorityWithoutMaterialization()
{
    var summary = MultiCollectionRangeSummary(MultiCollectionRange());
    var previous = SelectPreviousCollectionSequence(summary);
    var next = SelectNextCollectionSequence(summary);

    Xunit.Assert.Same(summary, previous.Summary);
    Xunit.Assert.Same(summary, next.Summary);
    Xunit.Assert.Null(previous.Selection);
    Xunit.Assert.Null(next.Selection);
    Xunit.Assert.False(previous.Succeeded);
    Xunit.Assert.False(next.Succeeded);
}
...
public void SummaryAndSelectionContractsExposeNoPublicSetters()
{
    ...
    Xunit.Assert.DoesNotContain(
        ...
        property => property.SetMethod is not null);
    Xunit.Assert.Same(
        summary.Range.CrossedBoundarySupersessions,
        summary.CrossedBoundarySupersessions);
}
...
public void ContractsRemainBoundedAndSideEffectFree()
{
    ...
    Xunit.Assert.Equal(3, methods.Length);
    Xunit.Assert.Contains(methods, method => method.Name == "ProjectSummary");
    Xunit.Assert.Contains(
        methods,
        method => method.Name == "SelectPreviousCollectionSequence");
    Xunit.Assert.Contains(
        methods,
        method => method.Name == "SelectNextCollectionSequence");
    Xunit.Assert.DoesNotContain(
        methods,
...
private static void AssertMultiCollectionRangeSummaryStatus(
    global::AI.Sandbox.Engine.Core.HostRuntime
        .HostRuntimeRecoveryMultiCollectionCheckpointRangeSummaryStatus expected,
    global::AI.Sandbox.Engine.Core.HostRuntime
        .HostRuntimeRecoveryMultiCollectionCheckpointRangeSummaryProjectionResult<
            RequestPayload,
            RecoveryWorldState,
...
private static void AssertAdjacentCollectionSequenceStatus(
    global::AI.Sandbox.Engine.Core.HostRuntime
        .HostRuntimeRecoveryMultiCollectionCheckpointRangeSummaryStatus expected,
    global::AI.Sandbox.Engine.Core.HostRuntime
        .HostRuntimeRecoveryAdjacentCollectionSequenceSelectionResult<
    ...
    Xunit.Assert.IsType<
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryMultiCollectionCheckpointRangeSummaryProjection<
                ...
                RecoveryWorldState,
                CompletionPayload>>(
                    ProjectMultiCollectionRangeSummary(range).Summary);
...
private static global::AI.Sandbox.Engine.Core.Identifiers.Id<
    ...
    MultiCollectionCheckpointRangeSummaryProjectionId() => Id<
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryMultiCollectionCheckpointRangeSummaryProjectionIdKind>(
                640001);
...
private static global::AI.Sandbox.Engine.Core.Identifiers.Id<
    ...
    AdjacentCollectionSequenceSelectionId() => Id<
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryAdjacentCollectionSequenceSelectionIdKind>(
                640002);
