...
public sealed class HostRuntimeRecoveryAdjacentSequenceProjectionContinuityTests
{
...
public void IdsRevisionsTicksAndArgumentsAreValidated()
{
    ...
    Xunit.Assert.Throws<ArgumentOutOfRangeException>(
        () => ProjectAdjacentSequence(context.Selection, projectedTick: -1));
        ...
        () => global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryAdjacentSequenceFlow.ValidateContinuity<
                ...
                CompletionPayload>(
                    ...
                    null!,
                    expectedSummaryRevision: context.Summary.Revision,
                    expectedAdjacentSequenceRevision: 0,
    ...
    Xunit.Assert.Throws<ArgumentOutOfRangeException>(
        () => ValidateSequenceContinuity(
            context.Summary,
            projection,
            expectedAdjacentSequenceRevision: -1));
    Xunit.Assert.Throws<ArgumentOutOfRangeException>(
        () => ValidateSequenceContinuity(
            context.Summary,
            projection,
...
public void ProjectionRejectsStaleRevisionAndRegressedTick()
{
    ...
    AssertAdjacentSequenceProjectionStatus(
        global::AI.Sandbox.Engine.Core.HostRuntime
...
[Xunit.Fact]
public void ProjectionRejectsPairBoundaryAndSupersessionEvidenceMismatch()
{
    var context = SyntheticContext();
    var wrongPairSelection = SyntheticSelection(
        context,
        context.Summary,
        pairSummaries: new[] { context.RangePair });
    AssertAdjacentSequenceProjectionStatus(
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryAdjacentSequenceProjectionStatus
            .SelectionPairSummaryMismatch,
        ProjectAdjacentSequence(wrongPairSelection));

    var wrongBoundarySelection = SyntheticSelection(
        context,
        context.Summary,
        boundarySupersessions: global::System.Array.Empty<
            global::AI.Sandbox.Engine.Core.HostRuntime
                .HostRuntimeRecoveryCheckpointSupersession<
                    RequestPayload,
                    RecoveryWorldState,
    ...
    AssertAdjacentSequenceProjectionStatus(
        ...
        ProjectAdjacentSequence(wrongBoundarySelection));

    var wrongOutgoingSelection = SyntheticSelection(
        context,
        context.Summary,
    ...
    AssertAdjacentSequenceProjectionStatus(
        ...
        ProjectAdjacentSequence(wrongOutgoingSelection));
}

[Xunit.Fact]
public void ProjectionMaterializesExactSelectedSequenceEvidence()
{
    var context = SyntheticContext();
    var result = ProjectAdjacentSequence(
        context.Selection,
    ...
    Xunit.Assert.True(projection.SelectsPreviousSequence);
    Xunit.Assert.False(projection.SelectsNextSequence);
    Xunit.Assert.Single(projection.PairSummaries);
    Xunit.Assert.Same(context.PreviousPair, projection.PairSummaries[0]);
...
public void ContinuityRejectsStaleRevisionsAndRegressedTick()
{
    ...
    AssertMultiWindowContinuityStatus(
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryAdjacentSequenceProjectionStatus
    ...
    AssertMultiWindowContinuityStatus(
        ...
        ValidateSequenceContinuity(
            context.Summary,
            projection,
            expectedAdjacentSequenceRevision: projection.Revision + 1));
    AssertMultiWindowContinuityStatus(
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryAdjacentSequenceProjectionStatus
...
[Xunit.Fact]
public void ContinuityRejectsSourcePairCheckpointAndBoundaryMismatch()
{
    var context = SyntheticContext();
    var projection = AdjacentSequenceProjection(context.Selection);
    var other = SyntheticContext(seed: 571000);

    AssertMultiWindowContinuityStatus(
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryAdjacentSequenceProjectionStatus
            .RangeSummaryMismatch,
        ValidateSequenceContinuity(other.Summary, projection));

    var overlappingSummary = SyntheticSummary(
        context,
        startPairIndex: 0,
        ...
        suffix: 572000);
    var overlappingSelection = SyntheticSelection(
        context,
        overlappingSummary,
        suffix: 572100);
    var overlappingProjection = AdjacentSequenceProjection(overlappingSelection);
    AssertMultiWindowContinuityStatus(
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryAdjacentSequenceProjectionStatus
            .PairRangeNotAdjacent,
        ValidateSequenceContinuity(overlappingSummary, overlappingProjection));

    var checkpointMismatchSummary = SyntheticSummary(
        context,
        startPairIndex: 1,
        ...
        incomingSupersession: context.Boundary,
        suffix: 573000);
    var checkpointMismatchSelection = SyntheticSelection(
        context,
        checkpointMismatchSummary,
        suffix: 573100);
    var checkpointMismatchProjection =
        AdjacentSequenceProjection(checkpointMismatchSelection);
    AssertMultiWindowContinuityStatus(
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryAdjacentSequenceProjectionStatus
    ...
    var missingBoundarySummary = SyntheticSummary(
        context,
        startPairIndex: 1,
        startCheckpointIndex: 1,
        checkpoint: context.SuccessorCheckpoint,
        ...
        suffix: 574000);
    var missingBoundarySelection = SyntheticSelection(
        context,
        missingBoundarySummary,
        suffix: 574100);
    var missingBoundaryProjection = AdjacentSequenceProjection(missingBoundarySelection);
    AssertMultiWindowContinuityStatus(
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryAdjacentSequenceProjectionStatus
...
[Xunit.Fact]
public void ContinuityValidatesExactPreviousSequenceBoundary()
{
    var context = SyntheticContext();
    var projection = AdjacentSequenceProjection(context.Selection);
    var result = ValidateSequenceContinuity(
        context.Summary,
        projection,
    ...
    Xunit.Assert.Same(projection, result.AdjacentSequence);
    Xunit.Assert.Same(context.Summary, validation.Summary);
    Xunit.Assert.Same(projection, validation.AdjacentSequence);
    Xunit.Assert.Same(context.Selection, validation.Selection);
    Xunit.Assert.True(validation.ValidatesPreviousSequence);
    Xunit.Assert.False(validation.ValidatesNextSequence);
    ...
    var validation = Xunit.Assert.IsType<
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryMultiWindowCheckpointRangeContinuityValidation<
                ...
                RecoveryWorldState,
                CompletionPayload>>(
                    ValidateSequenceContinuity(context.Summary, projection).Validation);
