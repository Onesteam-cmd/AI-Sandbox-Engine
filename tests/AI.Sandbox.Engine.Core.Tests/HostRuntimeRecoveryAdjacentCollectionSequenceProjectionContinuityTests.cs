...
public sealed class HostRuntimeRecoveryAdjacentCollectionSequenceProjectionContinuityTests
{
    ...
    private sealed record SyntheticAdjacentCollectionSequenceContext(
        global::AI.Sandbox.Engine.Core.HostRuntime
        ...
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryContinuousCollectionPairSummaryProjection<
                RequestPayload,
                RecoveryWorldState,
                CompletionPayload> CollectionPair,
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryCheckpointSupersession<
                RequestPayload,
                RecoveryWorldState,
...
{
    var context = AdjacentCollectionSequenceContext();

    Xunit.Assert.Throws<ArgumentException>(
        () => global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryAdjacentCollectionSequenceFlow
            .ProjectCollectionSequence<
                RequestPayload,
                RecoveryWorldState,
                CompletionPayload>(
                    projectionId: default,
                    selection: context.Selection,
                    expectedSelectionRevision: context.Selection.Revision,
                    projectedTick: context.Selection.SelectedTick));
    Xunit.Assert.Throws<ArgumentNullException>(
        () => global::AI.Sandbox.Engine.Core.HostRuntime
            ...
            .ProjectCollectionSequence<
                ...
                RecoveryWorldState,
                CompletionPayload>(
                    AdjacentCollectionSequenceProjectionId(),
                    null!,
                    expectedSelectionRevision: 0,
                    projectedTick: 0));
    Xunit.Assert.Throws<ArgumentOutOfRangeException>(
        () => ProjectAdjacentCollectionSequence(
            context.Selection,
    ...
    var projection = AdjacentCollectionSequenceProjection(context.Selection);
    Xunit.Assert.Throws<ArgumentException>(
        () => global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryAdjacentCollectionSequenceFlow
            .ValidateContinuity<
                ...
                CompletionPayload>(
                    ...
                    adjacentCollectionSequence: projection,
                    expectedSummaryRevision: context.Summary.Revision,
                    expectedAdjacentCollectionSequenceRevision:
                        projection.Revision,
                    validatedTick: projection.ProjectedTick));
    Xunit.Assert.Throws<ArgumentNullException>(
        () => global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryAdjacentCollectionSequenceFlow
            .ValidateContinuity<
                ...
                RecoveryWorldState,
                CompletionPayload>(
                    MultiCollectionCheckpointRangeContinuityValidationId(),
                    null!,
                    projection,
        ...
        () => global::AI.Sandbox.Engine.Core.HostRuntime
            ...
            .ValidateContinuity<
                ...
                CompletionPayload>(
                    ...
                    null!,
                    expectedSummaryRevision: context.Summary.Revision,
                    expectedAdjacentCollectionSequenceRevision: 0,
                    validatedTick: context.Summary.ProjectedTick));
    Xunit.Assert.Throws<ArgumentOutOfRangeException>(
        () => ValidateCollectionSequenceContinuity(
            context.Summary,
            projection,
    ...
    Xunit.Assert.Throws<ArgumentOutOfRangeException>(
        () => ValidateCollectionSequenceContinuity(
            context.Summary,
            projection,
            expectedAdjacentCollectionSequenceRevision: -1));
    Xunit.Assert.Throws<ArgumentOutOfRangeException>(
        () => ValidateCollectionSequenceContinuity(
            context.Summary,
            projection,
...
[Xunit.Fact]
public void ProjectionRejectsStaleRevisionAndRegressedTick()
{
    var context = AdjacentCollectionSequenceContext();

    AssertAdjacentCollectionSequenceProjectionStatus(
        global::AI.Sandbox.Engine.Core.HostRuntime
        ...
        ProjectAdjacentCollectionSequence(
            ...
            expectedSelectionRevision:
                checked(context.Selection.Revision + 1)));
    AssertAdjacentCollectionSequenceProjectionStatus(
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryAdjacentCollectionSequenceProjectionStatus
        ...
        ProjectAdjacentCollectionSequence(
            context.Selection,
            projectedTick: checked(context.Selection.SelectedTick - 1)));
}

[Xunit.Fact]
public void ProjectionRejectsCollectionPairBoundaryAndSupersessionEvidenceMismatch()
{
    var context = AdjacentCollectionSequenceContext();
    var other = AdjacentCollectionSequenceContext(seed: 651000);
    ...
    AssertAdjacentCollectionSequenceProjectionStatus(
        ...
        ProjectAdjacentCollectionSequence(
            SyntheticAdjacentCollectionSequenceSelection(
                context,
                collectionPairSummaries:
                    new[] { other.CollectionPair },
                suffix: 651100)));
    ...
    AssertAdjacentCollectionSequenceProjectionStatus(
        ...
        ProjectAdjacentCollectionSequence(
            SyntheticAdjacentCollectionSequenceSelection(
                context,
                incomingSupersession: context.Boundary,
                suffix: 651300)));
}

[Xunit.Fact]
public void ProjectionMaterializesExactSelectedCollectionSequenceEvidence()
{
    var context = AdjacentCollectionSequenceContext();
    var result = ProjectAdjacentCollectionSequence(
        context.Selection,
        projectedTick: checked(context.Selection.SelectedTick + 2));
    var projection = Xunit.Assert.IsType<
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryAdjacentCollectionSequenceProjection<
                RequestPayload,
                RecoveryWorldState,
                CompletionPayload>>(result.Projection);
    ...
    Xunit.Assert.Same(context.Selection, projection.Selection);
    Xunit.Assert.Same(context.Summary, projection.Summary);
    Xunit.Assert.Same(context.SourceSequence, projection.SourceSequence);
    Xunit.Assert.Same(
        context.SourceSequence.SourceCollection,
        projection.SourceCollection);
    Xunit.Assert.Same(
        context.Selection.CollectionPairSummaries,
        projection.CollectionPairSummaries);
    Xunit.Assert.Same(
        context.Selection.BoundarySupersessions,
        projection.BoundarySupersessions);
    Xunit.Assert.Same(context.Boundary, projection.AdjacentBoundarySupersession);
    Xunit.Assert.Same(context.CollectionPair.StartCheckpoint, projection.StartCheckpoint);
    Xunit.Assert.Same(context.CollectionPair.EndCheckpoint, projection.EndCheckpoint);
    Xunit.Assert.Equal(
        context.Selection.StartCollectionPairIndex,
        projection.StartCollectionPairIndex);
    Xunit.Assert.Equal(
        context.Selection.EndCollectionPairIndex,
        projection.EndCollectionPairIndex);
    Xunit.Assert.Equal(
        context.Selection.CollectionPairCount,
        projection.CollectionPairCount);
    Xunit.Assert.Equal(context.Selection.SummaryCount, projection.SummaryCount);
    Xunit.Assert.Equal(context.Selection.SequenceCount, projection.SequenceCount);
    Xunit.Assert.Equal(context.Selection.PairCount, projection.PairCount);
    Xunit.Assert.Equal(context.Selection.WindowCount, projection.WindowCount);
    Xunit.Assert.Equal(context.Selection.CheckpointCount, projection.CheckpointCount);
    Xunit.Assert.Equal(context.Selection.SupersessionCount, projection.SupersessionCount);
    Xunit.Assert.Equal(
        checked(context.Selection.Revision + 1),
        projection.Revision);
    Xunit.Assert.Equal(
        checked(context.Selection.SelectedTick + 2),
        projection.ProjectedTick);
}

[Xunit.Fact]
public void ContinuityRejectsStaleRevisionsAndRegressedTick()
{
    var context = AdjacentCollectionSequenceContext();
    var projection = AdjacentCollectionSequenceProjection(context.Selection);

    AssertMultiCollectionContinuityStatus(
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryAdjacentCollectionSequenceProjectionStatus
        ...
        ValidateCollectionSequenceContinuity(
            context.Summary,
            projection,
            expectedSummaryRevision: checked(context.Summary.Revision + 1)));
    AssertMultiCollectionContinuityStatus(
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryAdjacentCollectionSequenceProjectionStatus
    ...
    AssertMultiCollectionContinuityStatus(
        ...
        ValidateCollectionSequenceContinuity(
            context.Summary,
            projection,
            validatedTick: checked(
                global::System.Math.Max(
                    context.Summary.ProjectedTick,
                    projection.ProjectedTick) - 1)));
}

[Xunit.Fact]
public void ContinuityRejectsSourceSummaryAndAdjacencyMismatch()
{
    var context = AdjacentCollectionSequenceContext();
    var projection = AdjacentCollectionSequenceProjection(context.Selection);
    var otherSummary = SyntheticMultiCollectionRangeSummary(
        context,
        startCollectionPairIndex: 1,
        startCheckpointIndex:
            checked(context.CollectionPair.EndCheckpointIndex + 1),
        suffix: 652100);
    ...
    AssertMultiCollectionContinuityStatus(
        ...
        ValidateCollectionSequenceContinuity(otherSummary, projection));

    var pairGapSummary = SyntheticMultiCollectionRangeSummary(
        context,
        startCollectionPairIndex: 2,
        startCheckpointIndex:
            checked(context.CollectionPair.EndCheckpointIndex + 1),
        suffix: 652200);
    var pairGapProjection = AdjacentCollectionSequenceProjection(
        SyntheticAdjacentCollectionSequenceSelection(
            context,
            summary: pairGapSummary,
            suffix: 652210));
    AssertMultiCollectionContinuityStatus(
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryAdjacentCollectionSequenceProjectionStatus
    ...
    var checkpointGapSummary = SyntheticMultiCollectionRangeSummary(
        context,
        startCollectionPairIndex: 1,
        startCheckpointIndex:
            checked(context.CollectionPair.EndCheckpointIndex + 2),
        suffix: 652300);
    var checkpointGapProjection = AdjacentCollectionSequenceProjection(
        SyntheticAdjacentCollectionSequenceSelection(
            context,
            summary: checkpointGapSummary,
            suffix: 652310));
    AssertMultiCollectionContinuityStatus(
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryAdjacentCollectionSequenceProjectionStatus
        ...
        ValidateCollectionSequenceContinuity(
            ...
            checkpointGapProjection));
}

[Xunit.Fact]
public void ContinuityRejectsSupersessionAndCheckpointBoundaryMismatch()
{
    var context = AdjacentCollectionSequenceContext();
    var projection = AdjacentCollectionSequenceProjection(context.Selection);
    ...
    AssertMultiCollectionContinuityStatus(
        ...
        ValidateCollectionSequenceContinuity(context.Summary, projection));

    var selectionWithBoundaryOutgoing =
        SyntheticAdjacentCollectionSequenceSelection(
            context,
            outgoingSupersession: context.Boundary,
            suffix: 653100);
    var directProjection = ConstructNonPublic<
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryAdjacentCollectionSequenceProjection<
                RequestPayload,
                RecoveryWorldState,
                CompletionPayload>>(
                    Id<global::AI.Sandbox.Engine.Core.HostRuntime
                        .HostRuntimeRecoveryAdjacentCollectionSequenceProjectionIdKind>(
                            653101),
                    selectionWithBoundaryOutgoing,
                    global::System.Linq.Enumerable.ToArray(
                        projection.Checkpoints),
                    global::System.Linq.Enumerable.ToArray(
                        projection.Supersessions),
                    checked(projection.ProjectedTick + 1),
                    checked(projection.Revision + 1));
...
[Xunit.Fact]
public void ProjectionAndValidationCollectionsRemainImmutable()
{
    var context = AdjacentCollectionSequenceContext();
    var projection = AdjacentCollectionSequenceProjection(context.Selection);

    var checkpoints = Xunit.Assert.IsAssignableFrom<
        global::System.Collections.Generic.IList<
            global::AI.Sandbox.Engine.Core.HostRuntime
                .HostRuntimeRecoveryCheckpoint<RequestPayload>>>(
                    projection.Checkpoints);
    Xunit.Assert.Throws<NotSupportedException>(
        () => checkpoints.Add(context.CollectionPair.StartCheckpoint));

    var supersessions = Xunit.Assert.IsAssignableFrom<
        global::System.Collections.Generic.IList<
            global::AI.Sandbox.Engine.Core.HostRuntime
                .HostRuntimeRecoveryCheckpointSupersession<
                    RequestPayload,
                    ...
                    CompletionPayload>>>(
                        projection.Supersessions);
    Xunit.Assert.Throws<NotSupportedException>(
        () => supersessions.Add(context.Boundary));
...
{
    var methods = typeof(global::AI.Sandbox.Engine.Core.HostRuntime
        .HostRuntimeRecoveryAdjacentCollectionSequenceFlow)
        .GetMethods(
            global::System.Reflection.BindingFlags.Public |
            global::System.Reflection.BindingFlags.Static);

    Xunit.Assert.Equal(2, methods.Length);
    Xunit.Assert.Contains(
        methods,
        method => method.Name == "ProjectCollectionSequence");
    Xunit.Assert.Contains(
        methods,
        method => method.Name == "ValidateContinuity");
    Xunit.Assert.DoesNotContain(
        methods,
...
private static void AssertAdjacentCollectionSequenceProjectionStatus(
    global::AI.Sandbox.Engine.Core.HostRuntime
        .HostRuntimeRecoveryAdjacentCollectionSequenceProjectionStatus expected,
    global::AI.Sandbox.Engine.Core.HostRuntime
...
private static void AssertMultiCollectionContinuityStatus(
    global::AI.Sandbox.Engine.Core.HostRuntime
        .HostRuntimeRecoveryAdjacentCollectionSequenceProjectionStatus expected,
    global::AI.Sandbox.Engine.Core.HostRuntime
...
private static global::AI.Sandbox.Engine.Core.HostRuntime
    .HostRuntimeRecoveryAdjacentCollectionSequenceProjection<
        ...
        RecoveryWorldState,
        CompletionPayload>
    AdjacentCollectionSequenceProjection(
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryAdjacentCollectionSequenceSelection<
                RequestPayload,
                RecoveryWorldState,
    ...
    Xunit.Assert.IsType<
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryAdjacentCollectionSequenceProjection<
                ...
                RecoveryWorldState,
                CompletionPayload>>(
                    ProjectAdjacentCollectionSequence(selection).Projection);
...
private static global::AI.Sandbox.Engine.Core.HostRuntime
    ...
    ValidateCollectionSequenceContinuity(
        ...
        long? expectedAdjacentCollectionSequenceRevision = null,
        long? validatedTick = null) =>
    global::AI.Sandbox.Engine.Core.HostRuntime
        .HostRuntimeRecoveryAdjacentCollectionSequenceFlow.ValidateContinuity<
            RequestPayload,
            RecoveryWorldState,
            CompletionPayload>(
                MultiCollectionCheckpointRangeContinuityValidationId(),
...
private static SyntheticAdjacentCollectionSequenceContext
    AdjacentCollectionSequenceContext(int seed = 650000)
{
    var lowerContext = AdjacentCollectionContext(seed + 1000);
    var pair = CollectionPairSummary(lowerContext, seed + 100);
    var boundary = pair.ConnectingSupersession;
        ...
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryContinuousCollectionSequenceValidation<
                ...
                CompletionPayload>>(
                    ...
                    checked(pair.ProjectedTick + 1),
                    checked(pair.Revision + 1));

    var provisional = new SyntheticAdjacentCollectionSequenceContext(
        sourceSequence,
        null!,
        null!,
        pair,
        boundary);
    var summary = SyntheticMultiCollectionRangeSummary(
        provisional,
        startCollectionPairIndex: 1,
        startCheckpointIndex: checked(pair.EndCheckpointIndex + 1),
        suffix: seed + 200);
        ...
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryAdjacentCollectionSequenceSelection<
                ...
                CompletionPayload>>(
                    ...
                    null,
                    null,
                    checked(summary.ProjectedTick + 1),
                    checked(summary.Revision + 1));

    return new(sourceSequence, summary, selection, pair, boundary);
}
...
private static global::AI.Sandbox.Engine.Core.HostRuntime
    .HostRuntimeRecoveryAdjacentCollectionSequenceSelection<
        ...
        CompletionPayload>
    SyntheticAdjacentCollectionSequenceSelection(
        SyntheticAdjacentCollectionSequenceContext context,
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryMultiCollectionCheckpointRangeSummaryProjection<
                RequestPayload,
                RecoveryWorldState,
                CompletionPayload>? summary = null,
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryContinuousCollectionPairSummaryProjection<
                RequestPayload,
                RecoveryWorldState,
                CompletionPayload>[]? collectionPairSummaries = null,
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryCheckpointSupersession<
                RequestPayload,
                RecoveryWorldState,
        ...
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryCheckpointSupersession<
                RequestPayload,
                RecoveryWorldState,
                CompletionPayload>? incomingSupersession = null,
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryCheckpointSupersession<
                RequestPayload,
                RecoveryWorldState,
        ...
        int suffix = 650500)
{
    var currentSummary = summary ?? context.Summary;
        ...
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryAdjacentCollectionSequenceSelection<
                ...
                CompletionPayload>>(
                    ...
                    0,
                    collectionPairSummaries ??
                        new[] { context.CollectionPair },
                    boundarySupersessions ??
                        new[] { context.Boundary },
                    context.Boundary,
                    incomingSupersession,
                    outgoingSupersession,
                    checked(currentSummary.ProjectedTick + 1),
                    checked(currentSummary.Revision + 1));
}
...
private static global::AI.Sandbox.Engine.Core.HostRuntime
    .HostRuntimeRecoveryMultiCollectionCheckpointRangeSummaryProjection<
        ...
        RecoveryWorldState,
        CompletionPayload>
    SyntheticMultiCollectionRangeSummary(
        SyntheticAdjacentCollectionSequenceContext context,
        ...
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryMultiCollectionCheckpointRangeQuery<
                ...
                CompletionPayload>>(
                    ...
                    new[] { context.Boundary.SuccessorCheckpoint },
                    global::System.Array.Empty<
                        global::AI.Sandbox.Engine.Core.HostRuntime
                            .HostRuntimeRecoveryCheckpointSupersession<
                                RequestPayload,
                    ...
                    startCollectionPairIndex,
                    checked(context.SourceSequence.ValidatedTick + 1),
                    checked(context.SourceSequence.Revision + 1));
    return ConstructNonPublic<
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryMultiCollectionCheckpointRangeSummaryProjection<
                RequestPayload,
                ...
                CompletionPayload>>(
                    Id<global::AI.Sandbox.Engine.Core.HostRuntime
                        .HostRuntimeRecoveryMultiCollectionCheckpointRangeSummaryProjectionIdKind>(
                            suffix + 2),
                    query,
                    checked(query.QueriedTick + 1),
                    checked(query.Revision + 1));
}

private static global::AI.Sandbox.Engine.Core.Identifiers.Id<
    global::AI.Sandbox.Engine.Core.HostRuntime
        .HostRuntimeRecoveryAdjacentCollectionSequenceProjectionIdKind>
    AdjacentCollectionSequenceProjectionId() => Id<
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryAdjacentCollectionSequenceProjectionIdKind>(
                650001);
...
private static global::AI.Sandbox.Engine.Core.Identifiers.Id<
    ...
    MultiCollectionCheckpointRangeContinuityValidationId() => Id<
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryMultiCollectionCheckpointRangeContinuityValidationIdKind>(
                650002);
