...
public sealed class HostRuntimeRecoveryAdjacentCollectionProjectionContinuityTests
{
...
public void IdsRevisionsTicksAndArgumentsAreValidated()
{
    ...
    Xunit.Assert.Throws<ArgumentOutOfRangeException>(
        () => ValidateCollectionContinuity(
            context.Summary,
            projection,
            expectedAdjacentCollectionRevision: -1));
    Xunit.Assert.Throws<ArgumentOutOfRangeException>(
        () => ValidateCollectionContinuity(
            context.Summary,
            projection,
...
public void ProjectionRejectsStaleRevisionAndRegressedTick()
{
    ...
    AssertAdjacentCollectionProjectionStatus(
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryAdjacentCollectionProjectionStatus
            .StaleSelectionRevision,
        ProjectAdjacentCollection(
            context.Selection,
            expectedSelectionRevision: context.Selection.Revision + 1));
    AssertAdjacentCollectionProjectionStatus(
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryAdjacentCollectionProjectionStatus
        ...
        ProjectAdjacentCollection(
            context.Selection,
            projectedTick: context.Selection.SelectedTick - 1));
}

[Xunit.Fact]
public void ProjectionRejectsSummaryBoundaryAndSupersessionEvidenceMismatch()
{
    var context = AdjacentCollectionContext();

    var wrongSummarySelection = SyntheticAdjacentCollectionSelection(
        context,
        context.Summary,
        multiSequenceSummaries: new[] { context.RangeMultiSequenceSummary },
        suffix: 611100);
    AssertAdjacentCollectionProjectionStatus(
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryAdjacentCollectionProjectionStatus
            .SelectionSummaryMismatch,
        ProjectAdjacentCollection(wrongSummarySelection));

    var wrongBoundarySelection = SyntheticAdjacentCollectionSelection(
        context,
        context.Summary,
    ...
    AssertAdjacentCollectionProjectionStatus(
        ...
        ProjectAdjacentCollection(wrongBoundarySelection));

    var wrongSupersessionSelection = SyntheticAdjacentCollectionSelection(
        context,
        context.Summary,
        omitOutgoingSupersession: true,
        suffix: 611300);
    AssertAdjacentCollectionProjectionStatus(
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryAdjacentCollectionProjectionStatus
            .SelectionSupersessionMismatch,
        ProjectAdjacentCollection(wrongSupersessionSelection));
}

[Xunit.Fact]
public void ProjectionMaterializesExactSelectedCollectionEvidence()
{
    var context = AdjacentCollectionContext();
    var result = ProjectAdjacentCollection(
        context.Selection,
        projectedTick: context.Selection.SelectedTick + 2);
    ...
    Xunit.Assert.Same(context.SourceCollection, projection.SourceCollection);
    Xunit.Assert.Same(context.SourceProjection, projection.SourceProjection);
    Xunit.Assert.Same(context.SourceProjection.Chain, projection.Chain);
    Xunit.Assert.True(projection.SelectsPreviousCollection);
    Xunit.Assert.False(projection.SelectsNextCollection);
    Xunit.Assert.Single(projection.MultiSequenceSummaries);
    Xunit.Assert.Same(
        context.SelectedMultiSequenceSummary,
        projection.MultiSequenceSummaries[0]);
    Xunit.Assert.Single(projection.BoundarySupersessions);
    Xunit.Assert.Same(context.Boundary, projection.BoundarySupersessions[0]);
    Xunit.Assert.Single(projection.Checkpoints);
    Xunit.Assert.Same(context.PriorCheckpoint, projection.StartCheckpoint);
    Xunit.Assert.Same(context.PriorCheckpoint, projection.EndCheckpoint);
    Xunit.Assert.Empty(projection.Supersessions);
    Xunit.Assert.Same(context.Boundary, projection.AdjacentBoundarySupersession);
    Xunit.Assert.Null(projection.IncomingSupersession);
    Xunit.Assert.Same(context.Boundary, projection.OutgoingSupersession);
    Xunit.Assert.Equal(context.Selection.Revision + 1, projection.Revision);
    Xunit.Assert.Equal(context.Selection.SelectedTick + 2, projection.ProjectedTick);
}
...
public void ContinuityRejectsStaleRevisionsAndRegressedTick()
{
    ...
    AssertMultiSequenceContinuityStatus(
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryAdjacentCollectionProjectionStatus
        ...
        ValidateCollectionContinuity(
            context.Summary,
            projection,
            expectedSummaryRevision: context.Summary.Revision + 1));
    AssertMultiSequenceContinuityStatus(
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryAdjacentCollectionProjectionStatus
        ...
        ValidateCollectionContinuity(
            context.Summary,
            projection,
            expectedAdjacentCollectionRevision: projection.Revision + 1));
    AssertMultiSequenceContinuityStatus(
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryAdjacentCollectionProjectionStatus
        ...
        ValidateCollectionContinuity(
            context.Summary,
            projection,
            validatedTick: context.Summary.ProjectedTick - 1));
}

[Xunit.Fact]
public void ContinuityRejectsSourceSummaryCheckpointAndBoundaryMismatch()
{
    var context = AdjacentCollectionContext();
    var projection = AdjacentCollectionProjection(context.Selection);
    var other = AdjacentCollectionContext(seed: 612000);

    AssertMultiSequenceContinuityStatus(
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryAdjacentCollectionProjectionStatus
            .RangeSummaryMismatch,
        ValidateCollectionContinuity(other.Summary, projection));

    var overlappingSummary = SyntheticMultiSequenceRangeSummary(
        context,
        startSummaryIndex: 0,
        startCheckpointIndex: 1,
        checkpoint: context.SuccessorCheckpoint,
        incomingSupersession: context.Boundary,
        suffix: 612100);
    var overlappingSelection = SyntheticAdjacentCollectionSelection(
        context,
        overlappingSummary,
        suffix: 612200);
    var overlappingProjection =
        AdjacentCollectionProjection(overlappingSelection);
    AssertMultiSequenceContinuityStatus(
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryAdjacentCollectionProjectionStatus
        ...
        ValidateCollectionContinuity(
            overlappingSummary,
            overlappingProjection));

    var checkpointMismatchSummary = SyntheticMultiSequenceRangeSummary(
        context,
        startSummaryIndex: 1,
        startCheckpointIndex: 0,
        checkpoint: context.PriorCheckpoint,
        incomingSupersession: context.Boundary,
        suffix: 612300);
    var checkpointMismatchSelection = SyntheticAdjacentCollectionSelection(
        context,
        checkpointMismatchSummary,
        suffix: 612400);
    var checkpointMismatchProjection =
        AdjacentCollectionProjection(checkpointMismatchSelection);
    AssertMultiSequenceContinuityStatus(
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryAdjacentCollectionProjectionStatus
        ...
        ValidateCollectionContinuity(
            checkpointMismatchSummary,
            checkpointMismatchProjection));

    var missingBoundarySummary = SyntheticMultiSequenceRangeSummary(
        context,
        startSummaryIndex: 1,
        startCheckpointIndex: 1,
        checkpoint: context.SuccessorCheckpoint,
        ...
        suffix: 612500);
    var missingBoundarySelection = SyntheticAdjacentCollectionSelection(
        context,
        missingBoundarySummary,
        suffix: 612600);
    var missingBoundaryProjection =
        AdjacentCollectionProjection(missingBoundarySelection);
    AssertMultiSequenceContinuityStatus(
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryAdjacentCollectionProjectionStatus
        ...
        ValidateCollectionContinuity(
            missingBoundarySummary,
            missingBoundaryProjection));
}

[Xunit.Fact]
public void ContinuityValidatesExactPreviousCollectionBoundary()
{
    var context = AdjacentCollectionContext();
    var projection = AdjacentCollectionProjection(context.Selection);
    var result = ValidateCollectionContinuity(
        context.Summary,
        projection,
        validatedTick: projection.ProjectedTick + 2);
    var validation = Xunit.Assert.IsType<
        global::AI.Sandbox.Engine.Core.HostRuntime
    ...
    Xunit.Assert.Equal(
        ...
        result.Status);
    Xunit.Assert.Same(context.Summary, result.Summary);
    Xunit.Assert.Same(projection, result.AdjacentCollection);
    Xunit.Assert.Same(context.Summary, validation.Summary);
    Xunit.Assert.Same(projection, validation.AdjacentCollection);
    Xunit.Assert.Same(context.Selection, validation.Selection);
    Xunit.Assert.True(validation.ValidatesPreviousCollection);
    Xunit.Assert.False(validation.ValidatesNextCollection);
    Xunit.Assert.Same(context.Boundary, validation.ConnectingSupersession);
    Xunit.Assert.Same(context.PriorCheckpoint, validation.PriorCheckpoint);
    Xunit.Assert.Same(context.SuccessorCheckpoint, validation.SuccessorCheckpoint);
    Xunit.Assert.Equal(
        global::System.Math.Max(context.Summary.Revision, projection.Revision) + 1,
        validation.Revision);
    Xunit.Assert.Equal(projection.ProjectedTick + 2, validation.ValidatedTick);
}
...
public void ProjectionAndValidationCollectionsRemainImmutable()
{
    ...
    var checkpoints = Xunit.Assert.IsAssignableFrom<
        global::System.Collections.Generic.IList<
            global::AI.Sandbox.Engine.Core.HostRuntime
                .HostRuntimeRecoveryCheckpoint<RequestPayload>>>(projection.Checkpoints);
    Xunit.Assert.Throws<NotSupportedException>(
        () => checkpoints.Add(context.SuccessorCheckpoint));
        ...
        global::System.Collections.Generic.IList<
            global::AI.Sandbox.Engine.Core.HostRuntime
                .HostRuntimeRecoveryCheckpointSupersession<
                    RequestPayload,
                    RecoveryWorldState,
                    CompletionPayload>>>(projection.Supersessions);
    Xunit.Assert.Throws<NotSupportedException>(
...
public void ContractsRemainBoundedAndSideEffectFree()
{
    ...
    Xunit.Assert.Same(context.Summary.Range, projection.Summary.Range);
    Xunit.Assert.Same(context.SourceProjection.Chain, projection.Chain);
}
