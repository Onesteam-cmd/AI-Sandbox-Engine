...
public sealed class HostRuntimeRecoveryContinuousMultiSequenceCrossSequenceRangeTests
{
...
public void IdsRevisionsTicksAndArgumentsAreValidated()
{
    ...
    var continuity = MultiWindowContinuity(context);
    ...
    Xunit.Assert.Throws<ArgumentOutOfRangeException>(
        () => ProjectMultiSequence(continuity, expectedContinuityRevision: -1));
    Xunit.Assert.Throws<ArgumentOutOfRangeException>(
        () => ProjectMultiSequence(continuity, projectedTick: -1));

    var summary = MultiSequenceSummary(continuity);
    Xunit.Assert.Throws<ArgumentException>(
        () => global::AI.Sandbox.Engine.Core.HostRuntime
        ...
        () => global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryContinuousMultiSequenceFlow.QueryRange<
                ...
                CompletionPayload>(
                    ...
                    expectedMultiSequenceSummaryRevision: 0,
                    queriedTick: 0));
    Xunit.Assert.Throws<ArgumentException>(
        () => QueryCrossSequence(
            summary,
            ...
            endCheckpointId: default(
                global::AI.Sandbox.Engine.Core.Identifiers.Id<
                    global::AI.Sandbox.Engine.Core.HostRuntime
                        .HostRuntimeRecoveryCheckpointIdKind>)));
    Xunit.Assert.Throws<ArgumentOutOfRangeException>(
        () => QueryCrossSequence(summary, expectedSummaryRevision: -1));
    Xunit.Assert.Throws<ArgumentOutOfRangeException>(
        () => QueryCrossSequence(summary, queriedTick: -1));
}

[Xunit.Fact]
public void SummaryProjectionRejectsStaleRevisionAndRegressedTick()
{
    var continuity = MultiWindowContinuity(SyntheticContext());

    AssertMultiSequenceSummaryStatus(
        global::AI.Sandbox.Engine.Core.HostRuntime
...
[Xunit.Fact]
public void SummaryProjectionRejectsSourcePairAndSupersessionMismatch()
{
    var context = SyntheticContext();
    var projection = AdjacentSequenceProjection(context.Selection);
    var otherContext = SyntheticContext(seed: 580500);
    var otherProjection = AdjacentSequenceProjection(otherContext.Selection);
    ...
    AssertMultiSequenceSummaryStatus(
        ...
        ProjectMultiSequence(sourceMismatch));
    ...
    AssertMultiSequenceSummaryStatus(
        ...
        ProjectMultiSequence(overlappingContinuity));
    ...
    AssertMultiSequenceSummaryStatus(
        ...
        ProjectMultiSequence(wrongBoundaryContinuity));
}
...
public void SummaryProjectionPreservesExactContinuousEvidence()
{
    var context = SyntheticContext();
    var continuity = MultiWindowContinuity(context);
    var result = ProjectMultiSequence(
        continuity,
    ...
    Xunit.Assert.Same(continuity.AdjacentSequence, summary.AdjacentSequence);
    ...
    Xunit.Assert.True(summary.ConnectsPreviousSequence);
    Xunit.Assert.False(summary.ConnectsNextSequence);
    ...
    Xunit.Assert.Equal(0, summary.StartPairIndex);
    Xunit.Assert.Equal(1, summary.EndPairIndex);
    Xunit.Assert.Equal(2, summary.PairCount);
    Xunit.Assert.Equal(4, summary.WindowCount);
    Xunit.Assert.Equal(2, summary.SequenceCount);
...
[Xunit.Fact]
public void CrossSequenceQueryRejectsStaleRevisionAndRegressedTick()
{
    var summary = MultiSequenceSummary(MultiWindowContinuity(SyntheticContext()));

    AssertCrossSequenceQueryStatus(
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryContinuousMultiSequenceStatus
    ...
    AssertCrossSequenceQueryStatus(
        ...
        QueryCrossSequence(summary, queriedTick: summary.ProjectedTick - 1));
}

[Xunit.Fact]
public void QueryRejectsMissingReversedAndSingleSequenceRanges()
{
    var summary = MultiSequenceSummary(MultiWindowContinuity(SyntheticContext()));
    var missingId = Id<
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryCheckpointIdKind>(580099);

    AssertCrossSequenceQueryStatus(
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryContinuousMultiSequenceStatus.RangeStartNotFound,
        QueryCrossSequence(summary, startCheckpointId: missingId));
    AssertCrossSequenceQueryStatus(
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryContinuousMultiSequenceStatus.RangeEndNotFound,
        QueryCrossSequence(summary, endCheckpointId: missingId));
    AssertCrossSequenceQueryStatus(
        global::AI.Sandbox.Engine.Core.HostRuntime
...
[Xunit.Fact]
public void QueryPreservesExactCrossSequenceEvidence()
{
    var context = SyntheticContext();
    var summary = MultiSequenceSummary(MultiWindowContinuity(context));
    var result = QueryCrossSequence(summary, queriedTick: summary.ProjectedTick + 2);
    ...
    Xunit.Assert.Equal(
        ...
        result.Status);
    Xunit.Assert.Same(summary, result.MultiSequenceSummary);
    Xunit.Assert.Same(summary, query.MultiSequenceSummary);
    ...
    Xunit.Assert.True(query.CrossesSequenceBoundary);
    ...
    var query = Xunit.Assert.IsType<
        global::AI.Sandbox.Engine.Core.HostRuntime
            .HostRuntimeRecoveryCrossSequenceCheckpointRangeQuery<
                RequestPayload,
                RecoveryWorldState,
                CompletionPayload>>(QueryCrossSequence(summary).Query);
