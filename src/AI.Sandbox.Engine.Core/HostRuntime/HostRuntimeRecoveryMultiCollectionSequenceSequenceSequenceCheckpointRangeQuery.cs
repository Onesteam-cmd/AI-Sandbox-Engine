...
/// validated multi-collection-sequence-sequence boundaries of a continuous recovery multi-collection-sequence-sequence sequence.
/// </summary>
/// <typeparam name="TRequest">Exact Host request payload type.</typeparam>
/// <typeparam name="TState">Exact immutable World State root type.</typeparam>
/// <typeparam name="TCompletion">Exact Host completion payload type.</typeparam>
public sealed record HostRuntimeRecoveryMultiCollectionSequenceSequenceSequenceCheckpointRangeQuery<
    TRequest,
    TState,
    TCompletion>
...
{
    internal HostRuntimeRecoveryMultiCollectionSequenceSequenceSequenceCheckpointRangeQuery(
    ...
    /// <summary>Gets the externally assigned multi-collection-sequence-sequence-sequence checkpoint-range query ID.</summary>
    public global::AI.Sandbox.Engine.Core.Identifiers.Id<
        HostRuntimeRecoveryMultiCollectionSequenceSequenceSequenceCheckpointRangeQueryIdKind> QueryId { get; }

    /// <summary>Gets unchanged continuous multi-collection-sequence-sequence validation authority.</summary>
    ...
    /// <summary>Gets exact validated multi-collection-sequence-sequence boundaries crossed by the range.</summary>
    public global::System.Collections.Generic.IReadOnlyList<
        HostRuntimeRecoveryCheckpointSupersession<
            TRequest,
            TState,
    ...
    /// <summary>Gets the first intersected multi-collection-sequence-sequence-summary position in the sequence.</summary>
    public int StartSummaryIndex { get; }

    /// <summary>Gets the last intersected multi-collection-sequence-sequence-summary position in the sequence.</summary>
    ...
    /// <summary>Gets the number of intersected multi-collection-sequence-sequence summary authorities.</summary>
    ...
    public int SummaryCount => MultiCollectionSequenceSequenceSummaryCount;
    ...
    /// <summary>Gets the multi-collection-sequence-sequence-sequence checkpoint-range query authority revision.</summary>
