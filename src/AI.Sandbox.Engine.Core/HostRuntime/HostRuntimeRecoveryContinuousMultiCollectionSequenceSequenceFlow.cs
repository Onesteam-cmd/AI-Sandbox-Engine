...
/// and resolves bounded inclusive ranges across their validated multi-collection-sequence boundaries
...
/// </summary>
public static class HostRuntimeRecoveryContinuousMultiCollectionSequenceSequenceFlow
{
    /// <summary>Maximum summary projections represented by one sequence.</summary>
    public const int MaximumSummaryCount = 8;

    /// <summary>Maximum checkpoints represented by one multi-collection-sequence-sequence query.</summary>
    public const int MaximumCheckpointCount =
        HostRuntimeRecoveryContinuousMultiCollectionSequenceSummaryFlow.MaximumCheckpointCount;

    /// <summary>Validates one bounded exact sequence of continuous multi-collection-sequence summaries.</summary>
    public static HostRuntimeRecoveryContinuousMultiCollectionSequenceSequenceValidationResult<
        TRequest,
        TState,
        TCompletion> ValidateSequence<TRequest, TState, TCompletion>(
            global::AI.Sandbox.Engine.Core.Identifiers.Id<
                HostRuntimeRecoveryContinuousMultiCollectionSequenceSequenceValidationIdKind> validationId,
        ...
        where TCompletion : IHostRuntimeCompletion
    {
        ...
        global::System.ArgumentNullException.ThrowIfNull(multiCollectionSequenceSummaries);
        ...
        var snapshot =
            new HostRuntimeRecoveryContinuousMultiCollectionSequenceSummaryProjection<
                TRequest,
                TState,
                TCompletion>[multiCollectionSequenceSummaries.Count];
        for (var index = 0; index < snapshot.Length; index++)
        {
            global::System.ArgumentNullException.ThrowIfNull(
                multiCollectionSequenceSummaries[index]);
            snapshot[index] = multiCollectionSequenceSummaries[index];
        }
        ...
        for (var index = 0; index < snapshot.Length; index++)
        {
            ...
            if (current.StartSummaryIndex < 0 ||
                ...
                current.EndSummaryIndex >=
                    sourceSequence.MultiCollectionCount ||
                ...
                current.ConnectingPriorSummaryIndex < current.StartSummaryIndex ||
                current.ConnectingPriorSummaryIndex >= current.EndSummaryIndex ||
            ...
            if (index > 0)
            {
                ...
                if (previous.EndSummaryIndex + 1 != current.StartSummaryIndex)
                {
                    return SequenceResult<TRequest, TState, TCompletion>(
                        HostRuntimeRecoveryContinuousMultiCollectionSequenceSequenceStatus
        ...
        var validation =
            new HostRuntimeRecoveryContinuousMultiCollectionSequenceSequenceValidation<
                TRequest,
                TState,
                TCompletion>(
                    validationId,
        ...
        return new HostRuntimeRecoveryContinuousMultiCollectionSequenceSequenceValidationResult<
            TRequest,
            TState,
            TCompletion>(
                HostRuntimeRecoveryContinuousMultiCollectionSequenceSequenceStatus
    ...
    /// </summary>
    public static HostRuntimeRecoveryMultiCollectionSequenceSequenceCheckpointRangeQueryResult<
        TRequest,
        TState,
        ...
        where TCompletion : IHostRuntimeCompletion
    {
        ...
        var query =
            new HostRuntimeRecoveryMultiCollectionSequenceSequenceCheckpointRangeQuery<
                TRequest,
                TState,
                TCompletion>(
                    queryId,
        ...
        return new HostRuntimeRecoveryMultiCollectionSequenceSequenceCheckpointRangeQueryResult<
            TRequest,
            TState,
            TCompletion>(
                HostRuntimeRecoveryContinuousMultiCollectionSequenceSequenceStatus
    ...
    {
        for (var index = 0;
            index < sequence.MultiCollectionSequenceSummaries.Count;
            index++)
        {
            var summary = sequence.MultiCollectionSequenceSummaries[index];
    ...
    private static HostRuntimeRecoveryContinuousMultiCollectionSequenceSequenceValidationResult<
        TRequest,
        TState,
    ...
    private static HostRuntimeRecoveryMultiCollectionSequenceSequenceCheckpointRangeQueryResult<
        TRequest,
        TState,
    ...
    private static void EnsureId(bool isEmpty, string parameterName)
    {
        if (isEmpty)
        {
            throw new global::System.ArgumentException(
                "Recovery continuous multi-collection-sequence sequence identifiers cannot be empty.",
                parameterName);
        }
    }
    ...
    private static void EnsureRevision(long revision, string parameterName)
    {
        if (revision < 0)
        {
            throw new global::System.ArgumentOutOfRangeException(
                parameterName,
                revision,
                "Recovery continuous multi-collection-sequence sequence revisions cannot be negative.");
        }
    }
    ...
    private static void EnsureTick(long tick, string parameterName)
    {
        if (tick < 0)
        {
            throw new global::System.ArgumentOutOfRangeException(
                parameterName,
                tick,
                "Recovery continuous multi-collection-sequence sequence ticks cannot be negative.");
        }
    }
}
