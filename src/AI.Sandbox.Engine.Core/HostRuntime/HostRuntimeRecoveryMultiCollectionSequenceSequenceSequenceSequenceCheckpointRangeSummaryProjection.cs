...
/// <summary>
/// Contains a compact immutable projection of one exact bounded multi-collection-sequence-sequence-sequence
/// checkpoint-range query.
/// </summary>
/// <typeparam name="TRequest">Exact Host request payload type.</typeparam>
/// <typeparam name="TState">Exact immutable World State root type.</typeparam>
/// <typeparam name="TCompletion">Exact Host completion payload type.</typeparam>
public sealed record HostRuntimeRecoveryMultiCollectionSequenceSequenceSequenceSequenceCheckpointRangeSummaryProjection<
    TRequest,
    TState,
    TCompletion>
...
{
    internal HostRuntimeRecoveryMultiCollectionSequenceSequenceSequenceSequenceCheckpointRangeSummaryProjection(
    ...
    public global::AI.Sandbox.Engine.Core.Identifiers.Id<
        HostRuntimeRecoveryMultiCollectionSequenceSequenceSequenceSequenceCheckpointRangeSummaryProjectionIdKind> SummaryId { get; }

    /// <summary>Gets unchanged source multi-collection-sequence-sequence-sequence-sequence range authority.</summary>
    ...
    /// <summary>Gets exact crossed multi-collection-sequence-sequence-sequence boundary authorities.</summary>
    ...
    /// <summary>Gets first intersected multi-collection-sequence-sequence-sequence summary position.</summary>
    public int StartSummaryIndex => Range.StartSummaryIndex;

    /// <summary>Gets last intersected multi-collection-sequence-sequence-sequence summary position.</summary>
    ...
    /// <summary>Gets intersected multi-collection-sequence-sequence-sequence count.</summary>
    public int MultiCollectionSequenceSequenceSequenceCount => Range.MultiCollectionSequenceSequenceSequenceSummaryCount;
