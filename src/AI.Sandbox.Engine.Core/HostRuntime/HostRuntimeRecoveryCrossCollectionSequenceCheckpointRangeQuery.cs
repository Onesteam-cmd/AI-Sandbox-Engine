...
/// exact shared boundary of one continuous recovery multi-collection.
/// </summary>
/// <typeparam name="TRequest">Exact Host request payload type.</typeparam>
/// <typeparam name="TState">Exact immutable World State root type.</typeparam>
/// <typeparam name="TCompletion">Exact Host completion payload type.</typeparam>
public sealed record HostRuntimeRecoveryCrossCollectionSequenceCheckpointRangeQuery<
    TRequest,
    TState,
    TCompletion>
...
{
    internal HostRuntimeRecoveryCrossCollectionSequenceCheckpointRangeQuery(
    ...
    /// <summary>Gets the externally assigned cross-collection-sequence query ID.</summary>
    public global::AI.Sandbox.Engine.Core.Identifiers.Id<
        HostRuntimeRecoveryCrossCollectionSequenceCheckpointRangeQueryIdKind> QueryId { get; }

    /// <summary>Gets unchanged continuous multi-collection summary authority.</summary>
    ...
    public HostRuntimeRecoverySupersessionChain<
        TRequest,
        TState,
        TCompletion> Chain => MultiCollectionSummary.Chain;
    ...
    /// <summary>Gets the exact supersession connecting both source collection sequences.</summary>
    public HostRuntimeRecoveryCheckpointSupersession<
        TRequest,
        TState,
    ...
    public bool CrossesSequenceBoundary =>
        StartCheckpointIndex <= MultiCollectionSummary.ConnectingPriorCheckpointIndex &&
        EndCheckpointIndex >= MultiCollectionSummary.ConnectingSuccessorCheckpointIndex;

    /// <summary>Gets the external monotonic cross-collection-sequence query tick.</summary>
    public long QueriedTick { get; }

    /// <summary>Gets the cross-collection-sequence checkpoint-range query authority revision.</summary>
