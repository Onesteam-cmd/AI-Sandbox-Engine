...
/// exact shared boundary of one continuous recovery multi-collection-sequence-sequence-sequence.
/// </summary>
/// <typeparam name="TRequest">Exact Host request payload type.</typeparam>
/// <typeparam name="TState">Exact immutable World State root type.</typeparam>
/// <typeparam name="TCompletion">Exact Host completion payload type.</typeparam>
public sealed record HostRuntimeRecoveryCrossMultiCollectionSequenceSequenceCheckpointRangeQuery<
    TRequest,
    TState,
    TCompletion>
...
{
    internal HostRuntimeRecoveryCrossMultiCollectionSequenceSequenceCheckpointRangeQuery(
    ...
    /// <summary>Gets the externally assigned cross-multi-collection-sequence-sequence query ID.</summary>
    public global::AI.Sandbox.Engine.Core.Identifiers.Id<
        HostRuntimeRecoveryCrossMultiCollectionSequenceSequenceCheckpointRangeQueryIdKind> QueryId { get; }

    /// <summary>Gets unchanged continuous multi-collection-sequence-sequence summary authority.</summary>
    ...
    public HostRuntimeRecoverySupersessionChain<
        TRequest,
        TState,
        TCompletion> Chain => MultiCollectionSequenceSequenceSequenceSummary.Chain;
    ...
    /// <summary>Gets the exact supersession connecting both source multi-collection-sequence-sequence intervals.</summary>
    public HostRuntimeRecoveryCheckpointSupersession<
        TRequest,
        TState,
    ...
    public bool CrossesMultiCollectionSequenceSequenceBoundary =>
        StartCheckpointIndex <= MultiCollectionSequenceSequenceSequenceSummary.ConnectingPriorCheckpointIndex &&
        EndCheckpointIndex >= MultiCollectionSequenceSequenceSequenceSummary.ConnectingSuccessorCheckpointIndex;

    /// <summary>Gets the external monotonic cross-multi-collection-sequence-sequence query tick.</summary>
    public long QueriedTick { get; }

    /// <summary>Gets the cross-multi-collection-sequence-sequence checkpoint-range query authority revision.</summary>
