...
/// exact shared boundary of one continuous recovery multi-collection sequence.
/// </summary>
/// <typeparam name="TRequest">Exact Host request payload type.</typeparam>
/// <typeparam name="TState">Exact immutable World State root type.</typeparam>
/// <typeparam name="TCompletion">Exact Host completion payload type.</typeparam>
public sealed record HostRuntimeRecoveryCrossMultiCollectionCheckpointRangeQuery<
    TRequest,
    TState,
    TCompletion>
...
{
    internal HostRuntimeRecoveryCrossMultiCollectionCheckpointRangeQuery(
    ...
    /// <summary>Gets the externally assigned cross-multi-collection query ID.</summary>
    public global::AI.Sandbox.Engine.Core.Identifiers.Id<
        HostRuntimeRecoveryCrossMultiCollectionCheckpointRangeQueryIdKind> QueryId { get; }

    /// <summary>Gets unchanged continuous multi-collection-sequence summary authority.</summary>
    ...
    public HostRuntimeRecoverySupersessionChain<
        TRequest,
        TState,
        TCompletion> Chain => MultiCollectionSequenceSummary.Chain;
    ...
    /// <summary>Gets the exact supersession connecting both source multi-collection intervals.</summary>
    public HostRuntimeRecoveryCheckpointSupersession<
        TRequest,
        TState,
    ...
    public bool CrossesMultiCollectionBoundary =>
        StartCheckpointIndex <= MultiCollectionSequenceSummary.ConnectingPriorCheckpointIndex &&
        EndCheckpointIndex >= MultiCollectionSequenceSummary.ConnectingSuccessorCheckpointIndex;

    /// <summary>Gets the external monotonic cross-multi-collection query tick.</summary>
    public long QueriedTick { get; }

    /// <summary>Gets the cross-multi-collection checkpoint-range query authority revision.</summary>
