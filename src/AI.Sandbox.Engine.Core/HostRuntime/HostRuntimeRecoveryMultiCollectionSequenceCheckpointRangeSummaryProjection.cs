...
/// <summary>
/// Contains a compact immutable projection of one exact bounded multi-collection-sequence
/// checkpoint-range query.
/// </summary>
/// <typeparam name="TRequest">Exact Host request payload type.</typeparam>
/// <typeparam name="TState">Exact immutable World State root type.</typeparam>
/// <typeparam name="TCompletion">Exact Host completion payload type.</typeparam>
public sealed record HostRuntimeRecoveryMultiCollectionSequenceCheckpointRangeSummaryProjection<
    TRequest,
    TState,
    TCompletion>
...
{
    internal HostRuntimeRecoveryMultiCollectionSequenceCheckpointRangeSummaryProjection(
    ...
    /// <summary>Gets the externally assigned multi-collection-sequence summary ID.</summary>
    public global::AI.Sandbox.Engine.Core.Identifiers.Id<
        HostRuntimeRecoveryMultiCollectionSequenceCheckpointRangeSummaryProjectionIdKind> SummaryId { get; }

    /// <summary>Gets unchanged source multi-collection-sequence range authority.</summary>
    ...
    /// <summary>Gets first intersected multi-collection-summary index in the source sequence.</summary>
    public int StartSummaryIndex => Range.StartSummaryIndex;

    /// <summary>Gets last intersected multi-collection-summary index in the source sequence.</summary>
    ...
    /// <summary>Gets intersected multi-collection summary count.</summary>
    public int MultiCollectionCount => Range.SummaryCount;

    /// <summary>Gets represented collection-sequence count.</summary>
    ...
    /// <summary>Gets multi-collection-sequence summary authority revision.</summary>
