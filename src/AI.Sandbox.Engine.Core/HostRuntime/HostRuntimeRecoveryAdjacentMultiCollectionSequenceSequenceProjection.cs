...
/// projected from an exact adjacent multi-collection-sequence-sequence selection.
/// </summary>
/// <typeparam name="TRequest">Exact Host request payload type.</typeparam>
/// <typeparam name="TState">Exact immutable World State root type.</typeparam>
/// <typeparam name="TCompletion">Exact Host completion payload type.</typeparam>
public sealed record HostRuntimeRecoveryAdjacentMultiCollectionSequenceSequenceProjection<
    TRequest,
    TState,
    TCompletion>
...
{
    internal HostRuntimeRecoveryAdjacentMultiCollectionSequenceSequenceProjection(
    ...
    /// <summary>Gets externally assigned adjacent multi-collection-sequence-sequence projection ID.</summary>
    public global::AI.Sandbox.Engine.Core.Identifiers.Id<
        HostRuntimeRecoveryAdjacentMultiCollectionSequenceSequenceProjectionIdKind> ProjectionId { get; }
    ...
    public bool SelectsPreviousMultiCollectionSequenceSequence => Selection.SelectsPreviousMultiCollectionSequenceSequence;

    /// <summary>Gets whether the multi-collection-sequence follows the summarized range.</summary>
    public bool SelectsNextMultiCollectionSequenceSequence => Selection.SelectsNextMultiCollectionSequenceSequence;
    ...
    public global::System.Collections.Generic.IReadOnlyList<
        ...
        Selection.MultiCollectionSequenceSequenceSummaries;
    ...
    public int MultiCollectionSequenceSequenceCount => MultiCollectionSequenceSequenceSummaries.Count;
    ...
    /// <summary>Gets adjacent multi-collection-sequence-sequence projection revision.</summary>
