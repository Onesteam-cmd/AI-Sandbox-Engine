...
/// validated sequence boundaries of a continuous recovery multi-sequence collection.
/// </summary>
/// <typeparam name="TRequest">Exact Host request payload type.</typeparam>
/// <typeparam name="TState">Exact immutable World State root type.</typeparam>
/// <typeparam name="TCompletion">Exact Host completion payload type.</typeparam>
public sealed record HostRuntimeRecoveryMultiSequenceCheckpointRangeQuery<
    TRequest,
    TState,
    TCompletion>
...
{
    internal HostRuntimeRecoveryMultiSequenceCheckpointRangeQuery(
    ...
    /// <summary>Gets the externally assigned multi-sequence query ID.</summary>
    public global::AI.Sandbox.Engine.Core.Identifiers.Id<
        HostRuntimeRecoveryMultiSequenceCheckpointRangeQueryIdKind> QueryId { get; }

    /// <summary>Gets unchanged collection-validation authority.</summary>
    ...
    /// <summary>Gets exact validated sequence boundaries crossed by the range.</summary>
    public global::System.Collections.Generic.IReadOnlyList<
        HostRuntimeRecoveryCheckpointSupersession<
            TRequest,
            TState,
    ...
    /// <summary>Gets the first intersected summary index in the collection.</summary>
    public int StartSummaryIndex { get; }

    /// <summary>Gets the last intersected summary index in the collection.</summary>
    ...
    public int SummaryCount => checked(EndSummaryIndex - StartSummaryIndex + 1);

    /// <summary>Gets the number of intersected sequence authorities.</summary>
    ...
    /// <summary>Gets whether the query starts at the collection boundary.</summary>
    public bool StartsAtCollectionStart =>
        StartCheckpointIndex == Collection.StartCheckpointIndex;

    /// <summary>Gets whether the query ends at the collection boundary.</summary>
    public bool EndsAtCollectionEnd =>
        EndCheckpointIndex == Collection.EndCheckpointIndex;

    /// <summary>Gets the external monotonic query tick.</summary>
    public long QueriedTick { get; }

    /// <summary>Gets the multi-sequence query authority revision.</summary>
