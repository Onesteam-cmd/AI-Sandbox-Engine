...
public sealed record HostRuntimeRecoveryMultiCollectionSequenceSequenceCheckpointRangeSummaryProjection<
    TRequest,
    TState,
    TCompletion>
...
{
    internal HostRuntimeRecoveryMultiCollectionSequenceSequenceCheckpointRangeSummaryProjection(
    ...
    public global::AI.Sandbox.Engine.Core.Identifiers.Id<
        HostRuntimeRecoveryMultiCollectionSequenceSequenceCheckpointRangeSummaryProjectionIdKind> SummaryId { get; }

    /// <summary>Gets unchanged source multi-collection-sequence-sequence range authority.</summary>
    ...
    /// <summary>Gets exact crossed multi-collection-sequence boundary authorities.</summary>
    ...
    /// <summary>Gets first intersected multi-collection-sequence summary index.</summary>
    public int StartSummaryIndex => Range.StartSummaryIndex;

    /// <summary>Gets last intersected multi-collection-sequence summary index.</summary>
    ...
    /// <summary>Gets intersected multi-collection-sequence count.</summary>
    public int MultiCollectionSequenceCount => Range.MultiCollectionSequenceSummaryCount;
