...
/// continuous recovery multi-collection-sequence summary projections.
/// </summary>
/// <typeparam name="TRequest">Exact Host request payload type.</typeparam>
/// <typeparam name="TState">Exact immutable World State root type.</typeparam>
/// <typeparam name="TCompletion">Exact Host completion payload type.</typeparam>
public sealed record HostRuntimeRecoveryContinuousMultiCollectionSequenceSequenceValidation<
    TRequest,
    TState,
    TCompletion>
...
{
    internal HostRuntimeRecoveryContinuousMultiCollectionSequenceSequenceValidation(
    ...
    public global::AI.Sandbox.Engine.Core.Identifiers.Id<
        HostRuntimeRecoveryContinuousMultiCollectionSequenceSequenceValidationIdKind> ValidationId { get; }

    /// <summary>Gets exact ordered continuous multi-collection-sequence summary authorities.</summary>
    ...
    /// <summary>Gets the first exact multi-collection-sequence summary authority.</summary>
    ...
    /// <summary>Gets the last exact multi-collection-sequence summary authority.</summary>
    public HostRuntimeRecoveryContinuousMultiCollectionSequenceSummaryProjection<
        TRequest,
        TState,
        TCompletion> LastSummary => MultiCollectionSequenceSummaries[^1];

    /// <summary>Gets the unchanged source multi-collection-sequence authority.</summary>
    ...
    /// <summary>Gets the number of exact multi-collection-sequence summary authorities.</summary>
    public int MultiCollectionSequenceSummaryCount =>
        MultiCollectionSequenceSummaries.Count;
    ...
    /// <summary>Gets the sequence-validation authority revision.</summary>
