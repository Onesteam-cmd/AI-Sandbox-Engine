...
/// multi-collection-sequence-sequence-sequence of continuous multi-collection-sequence-sequence-sequence summaries adjacent
/// to one summarized range.
/// </summary>
/// <typeparam name="TRequest">Exact Host request payload type.</typeparam>
/// <typeparam name="TState">Exact immutable World State root type.</typeparam>
/// <typeparam name="TCompletion">Exact Host completion payload type.</typeparam>
public sealed record HostRuntimeRecoveryAdjacentMultiCollectionSequenceSequenceSequenceSelection<
    TRequest,
    TState,
    TCompletion>
...
{
    internal HostRuntimeRecoveryAdjacentMultiCollectionSequenceSequenceSequenceSelection(
        ...
        long revision)
    {
        ...
        Summary = summary;
        SelectsPreviousMultiCollectionSequenceSequenceSequence = selectsPreviousMultiCollectionSequenceSequenceSequence;
        StartSequenceSequenceSequenceSummaryIndex = startSequenceSequenceSequenceSummaryIndex;
    ...
    /// <summary>Gets externally assigned adjacent multi-collection-sequence-sequence-sequence selection ID.</summary>
    public global::AI.Sandbox.Engine.Core.Identifiers.Id<
        HostRuntimeRecoveryAdjacentMultiCollectionSequenceSequenceSequenceSelectionIdKind> SelectionId { get; }
    ...
    /// <summary>Gets whether the selection addresses the previous multi-collection-sequence-sequence-sequence.</summary>
    public bool SelectsPreviousMultiCollectionSequenceSequenceSequence { get; }

    /// <summary>Gets whether the selection addresses the next multi-collection-sequence-sequence-sequence.</summary>
    public bool SelectsNextMultiCollectionSequenceSequenceSequence => !SelectsPreviousMultiCollectionSequenceSequenceSequence;

    /// <summary>Gets exact selected multi-collection-sequence-sequence-sequence summaries in source order.</summary>
    ...
    public int StartSequenceSequenceSequenceSummaryIndex { get; }
    ...
    /// <summary>Gets selected multi-collection-sequence-sequence-sequence count.</summary>
    public int MultiCollectionSequenceSequenceSequenceCount =>
    ...
    public bool StartsAtSourceSequenceStart => StartSequenceSequenceSequenceSummaryIndex == 0;

    /// <summary>Gets whether selection ends at source sequence end.</summary>
    public bool EndsAtSourceSequenceEnd =>
        EndSequenceSequenceSequenceSummaryIndex == SourceSequence.MultiCollectionSequenceSequenceSequenceSummaryCount - 1;
