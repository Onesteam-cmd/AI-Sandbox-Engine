...
/// exact shared boundary of one continuous recovery multi-collection-sequence sequence.
/// </summary>
/// <typeparam name="TRequest">Exact Host request payload type.</typeparam>
/// <typeparam name="TState">Exact immutable World State root type.</typeparam>
/// <typeparam name="TCompletion">Exact Host completion payload type.</typeparam>
public sealed record HostRuntimeRecoveryCrossMultiCollectionSequenceCheckpointRangeQuery<
    TRequest,
    TState,
    TCompletion>
...
{
    internal HostRuntimeRecoveryCrossMultiCollectionSequenceCheckpointRangeQuery(
    ...
    /// <summary>Gets the externally assigned cross-multi-collection-sequence query ID.</summary>
    public global::AI.Sandbox.Engine.Core.Identifiers.Id<
        HostRuntimeRecoveryCrossMultiCollectionSequenceCheckpointRangeQueryIdKind> QueryId { get; }
    ...
    public HostRuntimeRecoverySupersessionChain<
        TRequest,
        TState,
        TCompletion> Chain => MultiCollectionSequenceSequenceSummary.Chain;
    ...
    /// <summary>Gets the exact supersession connecting both source multi-collection-sequence intervals.</summary>
    public HostRuntimeRecoveryCheckpointSupersession<
        TRequest,
        TState,
    ...
    public bool CrossesMultiCollectionSequenceBoundary =>
        StartCheckpointIndex <= MultiCollectionSequenceSequenceSummary.ConnectingPriorCheckpointIndex &&
        EndCheckpointIndex >= MultiCollectionSequenceSequenceSummary.ConnectingSuccessorCheckpointIndex;

    /// <summary>Gets the external monotonic cross-multi-collection-sequence query tick.</summary>
    public long QueriedTick { get; }

    /// <summary>Gets the cross-multi-collection-sequence checkpoint-range query authority revision.</summary>
