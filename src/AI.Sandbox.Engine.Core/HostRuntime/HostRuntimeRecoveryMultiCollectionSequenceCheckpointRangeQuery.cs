...
/// validated sequence boundaries of a continuous recovery multi-collection sequence.
/// </summary>
/// <typeparam name="TRequest">Exact Host request payload type.</typeparam>
/// <typeparam name="TState">Exact immutable World State root type.</typeparam>
/// <typeparam name="TCompletion">Exact Host completion payload type.</typeparam>
public sealed record HostRuntimeRecoveryMultiCollectionSequenceCheckpointRangeQuery<
    TRequest,
    TState,
    TCompletion>
...
{
    internal HostRuntimeRecoveryMultiCollectionSequenceCheckpointRangeQuery(
    ...
    /// <summary>Gets the externally assigned multi-collection-sequence checkpoint-range query ID.</summary>
    public global::AI.Sandbox.Engine.Core.Identifiers.Id<
        HostRuntimeRecoveryMultiCollectionSequenceCheckpointRangeQueryIdKind> QueryId { get; }
    ...
    /// <summary>Gets the multi-collection-sequence checkpoint-range query authority revision.</summary>
